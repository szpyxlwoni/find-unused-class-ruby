...
Gem::Specification.new do |s|
  ...
  s.date = "2013-03-21"
  s.description = "Nokogiri (\303\251\213\302\270) is an HTML, XML, SAX, and Reader parser.  Among Nokogiri's\nmany features is the ability to search documents via XPath or CSS3 selectors.\n\nXML is like violence - if it doesn\303\242\200\231t solve your problems, you are not using\nenough of it."
  ...
  s.summary = "Nokogiri (\303\251\213\302\270) is an HTML, XML, SAX, and Reader parser"
